...
\label{sec:related}
% ============================================================
Prior work spans rule-based relays, shallow ML, and deep learning. Impedance/threshold
methods are interpretable but depend on accurate parameters \cite{chen2020,liao2021}.
CNNs reduce feature engineering but assume an ordered Euclidean input and can be
sensitive to bus indexing \cite{owerko2020}. GNNs better match the topology by
aggregating along connections \cite{kipf2017} and have been used for grid diagnosis and
related tasks \cite{chen2020,donon2019,james2020}. Many prior approaches, however, focus
on static snapshots; fault signatures are spatiotemporal. Motivated by spatiotemporal
graph modeling \cite{yu2018}, we combine graph message passing with temporal sequence
modeling for bus-level fault localization.
